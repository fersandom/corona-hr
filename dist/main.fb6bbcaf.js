...
},{"moment":"../node_modules/moment/moment.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
function fetchData() {
  fetch("https://api.covid19api.com/dayone/country/".concat(countryList.value, "/status/confirmed"), requestOptions).then(function (response) {
    return response.json();
  }).then(function (data) {
    var arrayCases = data; //   //Calculates infection ratio for 100000 inhabitants
